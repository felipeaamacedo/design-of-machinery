...
/**
 * Forward kinematics of an RR kinematic pair
 * @param c Input length of the first link
 * @param b Input length of the second link
 * @param PHI Input the initial angle of the first joint
 * @param PSI Input the initial angle of the second joint
 * @param PHI_d Input the initial angular velocity of the fist joint
 * @param PSI_d Input the initial angular velocity of the second joint
 * @param PHI_dd Input the initial angular velocity of the fist joint
 * @param PSI_dd Input the initial angular velocity of the second joint
 *
*/
...
export function RR_Inv(b:number, c:number, Xq:number, Yq:number, Xa:number, Ya:number, X_d:number, Y_d:number, X_dd:number, Y_dd:number, I:number):number[]{
	...
	let PHI_dd:number = L.data[0][0]
	let PSI_dd = L.data[1][0]
